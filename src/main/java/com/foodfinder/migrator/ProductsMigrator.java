...
import com.foodfinder.migrator.dto.UsdaFoodResponseDTO;
import com.foodfinder.food.domain.*;
...
class ProductsMigrator {
    ...
    private void migrateProductsForGroup(FoodGroupResponseDTO foodGroup, RestTemplate restTemplate,
        ...
        FoodGroup dbFoodGroup = foodGroupRepository.findByDescription(foodGroup.getName());
